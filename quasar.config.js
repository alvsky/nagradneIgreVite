...
// const fs = require('fs') // -- NOVA LINIJA (za ssl certifikat)
...
module.exports = configure(function (ctx) {
  return {
    ...
    boot: [
      ctx.mode.capacitor ? 'inject-capacitor' : 'no-capacitor',
      'admob',
      'store',
      'i18n'
    ...
    capacitor: {
      ...
      description: 'Sve nagradne igre na jednom mjestu' // string
    },
