...
const state = reactive({
  ...
  countries: [
    { label: 'Hrvatska', name: 'hr', host: 'nagradnaigra.com.hr', icon: 'img:flags/hr.svg' },
    { label: 'Srbija', name: 'rs', host: 'nagradneigrers.com', icon: 'img:flags/rs.svg' },
    { label: 'Slovenija', name: 'si', host: 'nagradneigresi.com', icon: 'img:flags/si.svg' }
  ],
...
const actions = {
  ...
  async fetchPrivPolicy (country) {
    ...
    let ppLink = "https://nagradnaigra.com.hr/privacy-policy"
